...
def datafr():
    df= pd.read_csv("/Users/karthimurugesan/Desktop/Airbnb/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("/Users/karthimurugesan/Desktop/Airbnb/vinnytsia-ukraine-june-23-2023-600nw-2321769253.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("/Users/karthimurugesan/Desktop/Airbnb/Airbnb.csv")
            return df_a
